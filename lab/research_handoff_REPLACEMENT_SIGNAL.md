...
Constants not extracted for this handoff: SPIKE_RANGE_MULT, MIN_TP_DIST_FRAC (defined in the lab import chain; values UNKNOWN here — read from `multislot_ablation.py` if auditing the sim's spike filter and TP-distance floor).
